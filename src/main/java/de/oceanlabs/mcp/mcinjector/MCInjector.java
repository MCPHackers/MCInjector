...
public class MCInjector {
	...
	public static final String VERSION = "MCInjector v"
			+ Optional.ofNullable(MCInjector.class.getPackage().getImplementationVersion()).orElse("Unknown")
			+ " by Searge, LexManos, Fesh0r";
	...
	public static void main(String[] args) throws Exception {
		...
		OptionSpec<Level> logLvl = parser.accepts("level").withRequiredArg().withValuesConvertedBy(LEVEL_ARG)
		...
		try {
			...
			try {
				new MCInjector(o.valueOf(in), o.valueOf(out)).log().log(o.valueOf(log)).exceptions(o.valueOf(exc))
						.exceptionsOut(o.valueOf(excOut)).access(o.valueOf(acc)).accessOut(o.valueOf(accOut))
						.constructors(o.valueOf(ctr)).constructorsOut(o.valueOf(ctrOut)).process();
			} catch (Exception e) {
